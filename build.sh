...
gcc -c main.c -o "build/main.o" -m32 -ggdb
gcc -c keyboard.c -o "build/keyboard.o" -m32 -ggdb
gcc -c video.c -o "build/video.o" -m32 -ggdb
gcc -c interrupt.c -o "build/interrupt.o" -m32 -ggdb

#Linking files...
echo Linking files...
ld -Tlinker.ld -m elf_i386 --nmagic -nostdlib -static -o "build/bootload.elf" -M > "build/map.txt"
